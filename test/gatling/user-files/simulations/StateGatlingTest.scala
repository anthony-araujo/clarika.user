 ...
 */
class StateGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the State entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created state")
                .get("${new_state_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created state")
            .delete("${new_state_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
