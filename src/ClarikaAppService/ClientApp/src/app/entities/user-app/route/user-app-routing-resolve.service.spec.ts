...
describe("UserApp routing resolve service", () => {
  ...
  let routingResolveService: UserAppRoutingResolveService;
  let service: UserAppService;
  let resultUserApp: IUserApp | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(UserAppRoutingResolveService);
  ...
  describe("resolve", () => {
    ...
    it("should return new IUserApp if id is not provided", () => {
      // GIVEN
      ...
      expect(resultUserApp).toEqual(new UserApp());
    });
    ...
    it("should route to 404 page if data not found in server", () => {
      ...
      jest
        .spyOn(service, "find")
        .mockReturnValue(
          of(new HttpResponse({ body: null as unknown as UserApp }))
        );
      mockActivatedRouteSnapshot.params = { id: 123 };
